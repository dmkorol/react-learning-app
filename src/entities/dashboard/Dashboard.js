...
import initCharts from "./dashboard-charts";
    ...
    return (
        <>
            <div className="d-sm-flex align-items-center">
                ...
                {/*    <i className="fas fa-download fa-sm"/> Generate Report</button>*/}
                </div>
            </div>
            <p>Mocked data without calling API.</p>
            <div className="row">
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <p>Add some quality, svg illustrations to your project courtesy of <a target="_blank"
                                ...
                                a constantly updated collection of beautiful svg images that you can use completely free
